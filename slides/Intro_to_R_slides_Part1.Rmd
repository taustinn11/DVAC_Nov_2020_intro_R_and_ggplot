...
- R is an object-oriented programming language built by statisticians Ross Ihaka and Robert Gentleman (CITE)
  - Robert Gentleman is also an originator of the Bioconductor Project (CITE)
  - R is used heavily in the academic community (particularly in biology) as well in industry settings

- R has a TON of applications beyond biostatistics and biological data viz like scraping data, building apps, plotting of several kinds of data, interacting with databases, software engineering, and developing machine learning models, etc.
